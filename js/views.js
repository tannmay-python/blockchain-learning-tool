...
export const VIEWS = (function () {
  ...
  const SOCIALS = `<div style="display:flex; justify-content:center; align-items:center; gap: 14px; flex-wrap:wrap; margin-top: 12px;">
          ...
          <span>· sibling to <a href="https://tannmay-python.github.io/ai-learning-tool/" style="color:var(--ink-3); text-decoration:none; border-bottom:1px solid var(--line-2); transition:color 0.2s;" onmouseover="this.style.color='var(--plum)'" onmouseout="this.style.color='var(--ink-3)'">The AI Course</a></span>
        </div>`;
