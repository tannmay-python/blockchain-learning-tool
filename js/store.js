...
export const STORE = (function () {
  ...
  const WORLDS = [
    ...
    { id: "foundations", n: "01", title: "The big idea", sub: "What a blockchain actually is", color: "oklch(0.60 0.078 18)", colorText: "oklch(0.45 0.088 18)", colorTextDark: "oklch(0.85 0.080 18)", lessons: ["whatis", "tour"],
    ...
    { id: "crypto", n: "02", title: "Cryptography", sub: "The two tools everything is built from", color: "oklch(0.60 0.078 52)", colorText: "oklch(0.45 0.088 52)", colorTextDark: "oklch(0.85 0.080 52)", lessons: ["hashing", "keys"],
    ...
    { id: "chain", n: "03", title: "Building the chain", sub: "Bundling, mining, and locking the past", color: "oklch(0.60 0.078 92)", colorText: "oklch(0.45 0.088 92)", colorTextDark: "oklch(0.85 0.080 92)", lessons: ["tx", "block", "merkle", "nonce", "incentives", "chainlink"],
    ...
    { id: "consensus", n: "04", title: "The network agrees", sub: "Thousands of strangers, one history", color: "oklch(0.60 0.078 150)", colorText: "oklch(0.45 0.088 150)", colorTextDark: "oklch(0.85 0.080 150)", lessons: ["gossip", "sybil", "forks", "attack", "pos"],
    ...
    { id: "progmoney", n: "05", title: "Programmable money", sub: "Contracts, tokens, and markets made of code", color: "oklch(0.60 0.078 185)", colorText: "oklch(0.45 0.088 185)", colorTextDark: "oklch(0.85 0.080 185)", lessons: ["contracts", "tokens", "amm", "mev"],
    ...
    { id: "keysworld", n: "06", title: "Your keys, your problem", sub: "Custody, and the ways people lose everything", color: "oklch(0.60 0.078 232)", colorText: "oklch(0.45 0.088 232)", colorTextDark: "oklch(0.85 0.080 232)", lessons: ["wallets", "safety"],
    ...
    { id: "scaling", n: "07", title: "Scaling, privacy & the state", sub: "Layer 2, zero-knowledge, and public money", color: "oklch(0.60 0.078 275)", colorText: "oklch(0.45 0.088 275)", colorTextDark: "oklch(0.85 0.080 275)", lessons: ["layer2", "zk", "money"],
    ...
    { id: "history", n: "08", title: "How it went wrong", sub: "The disasters that proved the rules", color: "oklch(0.60 0.078 315)", colorText: "oklch(0.45 0.088 315)", colorTextDark: "oklch(0.85 0.080 315)", lessons: ["history"],
    ...
    { id: "capstone", n: "09", title: "The whole machine", sub: "Watch every piece work together", color: "oklch(0.60 0.078 358)", colorText: "oklch(0.45 0.088 358)", colorTextDark: "oklch(0.85 0.080 358)", lessons: ["recap", "coin"],
