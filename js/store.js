...
export const STORE = (function () {
  ...
  const WORLDS = [
    { id: "primer", n: "00", title: "Start here", sub: "Money, trust, and the core problem", color: "#cbd5e1", colorText: "#334155", colorTextDark: "#94a3b8", lessons: ["ledger", "why", "doublespend"],
    ...
    { id: "foundations", n: "01", title: "The big idea", sub: "What a blockchain actually is", color: "#f9a8d4", colorText: "#9d174d", colorTextDark: "#f472b6", lessons: ["whatis", "tour"],
    ...
    { id: "crypto", n: "02", title: "Cryptography", sub: "The two tools everything is built from", color: "#fcd34d", colorText: "#92400e", colorTextDark: "#fbbf24", lessons: ["hashing", "keys"],
    ...
    { id: "chain", n: "03", title: "Building the chain", sub: "Bundling, mining, and locking the past", color: "#a5b4fc", colorText: "#3730a3", colorTextDark: "#818cf8", lessons: ["tx", "block", "merkle", "nonce", "incentives", "chainlink"],
    ...
    { id: "consensus", n: "04", title: "The network agrees", sub: "Thousands of strangers, one history", color: "#fda4af", colorText: "#9f1239", colorTextDark: "#fb7185", lessons: ["gossip", "sybil", "forks", "attack", "pos"],
    ...
    { id: "progmoney", n: "05", title: "Programmable money", sub: "Contracts, tokens, and markets made of code", color: "#6ee7b7", colorText: "#065f46", colorTextDark: "#34d399", lessons: ["contracts", "tokens", "amm", "mev"],
    ...
    { id: "keysworld", n: "06", title: "Your keys, your problem", sub: "Custody, and the ways people lose everything", color: "#d8b4fe", colorText: "#6b21a8", colorTextDark: "#c084fc", lessons: ["wallets", "safety"],
    ...
    { id: "scaling", n: "07", title: "Scaling, privacy & the state", sub: "Layer 2, zero-knowledge, and public money", color: "#5eead4", colorText: "#115e59", colorTextDark: "#2dd4bf", lessons: ["layer2", "zk", "money"],
    ...
    { id: "history", n: "08", title: "How it went wrong", sub: "The disasters that proved the rules", color: "#fdba74", colorText: "#9a3412", colorTextDark: "#fb923c", lessons: ["history"],
    ...
    { id: "capstone", n: "09", title: "The whole machine", sub: "Watch every piece work together", color: "#93c5fd", colorText: "#1e40af", colorTextDark: "#60a5fa", lessons: ["recap", "coin"],
